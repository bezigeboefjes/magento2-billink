...
namespace Balticode\Billink\Model\Fee;

use Balticode\Billink\Helper\Fee as FeeHelper;
use Balticode\Billink\Helper\Quote as QuoteHelper;
use Magento\Framework\DataObject;
use Magento\Tax\Model\CalculationFactory;

/**
 * Class BillinkFee
 * @package Balticode\Billink\Model\Fee
 */
class BillinkFee
{
    /**
    ...
    private function getWorkflowTypeFromRequest()
    {
        ...
        if (!isset($payment[\Balticode\Billink\Observer\DataAssignObserver::CUSTOMER_TYPE])) {
            return false;
        }

        return $payment[\Balticode\Billink\Observer\DataAssignObserver::CUSTOMER_TYPE];
    }
}