...
namespace Balticode\Billink\Gateway\Config;
...
/**
 * Class Config
 * @package Balticode\Billink\Gateway\Config
 */
class Config extends \Magento\Payment\Gateway\Config\Config
{
    ...
    public function getLogo(Interceptor $store = null)
    {
        ...
        if (!$value) {
            return $this->assetRepository->getUrl('Balticode_Billink::images/logo.png');
        }
